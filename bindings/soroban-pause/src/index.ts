...
export const networks = {
  testnet: {
    ...
    contractId: "CB2DC6KLAI4577GPGQWFG2LSXPBVE4IJGDP7ETKFKNXD2IRSQAFD643F",
  }
} as const
...
export interface Client {
   ...
   */
  set: ({paused}: {paused: boolean}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAADc2V0AAAAAAEAAAAAAAAABnBhdXNlZAAAAAAAAQAAAAA=",
