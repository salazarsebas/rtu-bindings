...
export class Client extends ContractClient {
    ...
    constructor(options) {
        super(new ContractSpec(["AAAABAAAAAAAAAAAAAAACUdhbWVFcnJvcgAAAAAAAAQAAAAAAAAADk5vdEluaXRpYWxpemVkAAAAAAABAAAAAAAAABJBbHJlYWR5SW5pdGlhbGl6ZWQAAAAAAAIAAAAAAAAACEdhbWVPdmVyAAAAAwAAAAAAAAANSW52YWxpZEFjdGlvbgAAAAAAAAQ=",
    ...
    fromJSON = {
        shoot: (this.txFromJSON),
        get_score: (this.txFromJSON),
        init_game: (this.txFromJSON),
        rotate_ship: (this.txFromJSON),
        thrust_ship: (this.txFromJSON),
