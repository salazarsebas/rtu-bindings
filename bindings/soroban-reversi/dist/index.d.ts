...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CCE4NZWAIRGJPBHR2DYQ7RT3OH2VDOPU6AZ2T2YIOXM6RC7Z7IC6KVYX";
    };
};
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        get_board: (json: string) => AssembledTransaction<BoardState>;
        get_score: (json: string) => AssembledTransaction<ScoreState>;
