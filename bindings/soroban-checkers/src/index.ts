...
export const networks = {
  testnet: {
    ...
    contractId: "CBNZJLQK5VOIU6AOMJZEKECONMJR4KHDKTOKZ3KKKZV5UIKDDORBZMGV",
  }
} as const
 ...
 */
export type GameStatus = {tag: "Active", values: void} | {tag: "Finished", values: void};

export const CheckersError = {
  /**
 ...
 */
export interface TurnComponent {
  /**
...
export interface Client {
   ...
   */
  get_board: (options?: MethodOptions) => Promise<AssembledTransaction<Result<BoardState>>>
   ...
   */
  get_state: (options?: MethodOptions) => Promise<AssembledTransaction<Result<GameState>>>
   ...
   */
  init_game: ({player_one, player_two}: {player_one: string, player_two: string}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  submit_move: ({player, from_row, from_col, to_row, to_col}: {player: string, from_row: u32, from_col: u32, to_row: u32, to_col: u32}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>

  /**
   * Construct and simulate a get_current_player transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Return the `Address` of the player whose turn it currently is.
   */
  get_current_player: (options?: MethodOptions) => Promise<AssembledTransaction<Result<string>>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        "AAAAAQAAACdCb2FyZCBzbmFwc2hvdCByZXR1cm5lZCBieSBgZ2V0X2JvYXJkYC4AAAAAAAAAAApCb2FyZFN0YXRlAAAAAAABAAAAAAAAAAVjZWxscwAAAAAAA+oAAAAF",
        "AAAAAgAAABxMaWZlY3ljbGUgc3RhdGUgb2YgdGhlIGdhbWUuAAAAAAAAAApHYW1lU3RhdHVzAAAAAAACAAAAAAAAAAAAAAAGQWN0aXZlAAAAAAAAAAAAAAAAAAhGaW5pc2hlZA==",
        "",
        "",
        "AAAAAQAAAAAAAAAAAAAADkJvYXJkQ29tcG9uZW50AAAAAAABAAAAAAAAAAVjZWxscwAAAAAAA+oAAAAF",
        "",
        "AAAAAAAAADxSZXR1cm4gdGhlIGN1cnJlbnQgYm9hcmQgY2VsbHMgKDY0IHZhbHVlcywgcm93LW1ham9yIG9yZGVyKS4AAAAJZ2V0X2JvYXJkAAAAAAAAAAAAAAEAAAPpAAAH0AAAAApCb2FyZFN0YXRlAAAAAAfQAAAADUNoZWNrZXJzRXJyb3IAAAA=",
        "AAAAAAAAACRSZXR1cm4gdGhlIGZ1bGwgZ2FtZSBzdGF0ZSBzbmFwc2hvdC4AAAAJZ2V0X3N0YXRlAAAAAAAAAAAAAAEAAAPpAAAH0AAAAAlHYW1lU3RhdGUAAAAAAAfQAAAADUNoZWNrZXJzRXJyb3IAAAA=",
        "AAAAAAAAAAAAAAAJaW5pdF9nYW1lAAAAAAAAAgAAAAAAAAAKcGxheWVyX29uZQAAAAAAEwAAAAAAAAAKcGxheWVyX3R3bwAAAAAAEwAAAAEAAAPpAAAAAgAAB9AAAAANQ2hlY2tlcnNFcnJvcgAAAA==",
        "AAAAAAAAAAAAAAALc3VibWl0X21vdmUAAAAABQAAAAAAAAAGcGxheWVyAAAAAAATAAAAAAAAAAhmcm9tX3JvdwAAAAQAAAAAAAAACGZyb21fY29sAAAABAAAAAAAAAAGdG9fcm93AAAAAAAEAAAAAAAAAAZ0b19jb2wAAAAAAAQAAAABAAAD6QAAAAIAAAfQAAAADUNoZWNrZXJzRXJyb3IAAAA=",
        "AAAAAAAAAD5SZXR1cm4gdGhlIGBBZGRyZXNzYCBvZiB0aGUgcGxheWVyIHdob3NlIHR1cm4gaXQgY3VycmVudGx5IGlzLgAAAAAAEmdldF9jdXJyZW50X3BsYXllcgAAAAAAAAAAAAEAAAPpAAAAEwAAB9AAAAANQ2hlY2tlcnNFcnJvcgAAAA==",
  ...
  public readonly fromJSON = {
    get_board: this.txFromJSON<Result<BoardState>>,
        get_state: this.txFromJSON<Result<GameState>>,
        init_game: this.txFromJSON<Result<void>>,
        submit_move: this.txFromJSON<Result<void>>,
        get_current_player: this.txFromJSON<Result<string>>
  }
}