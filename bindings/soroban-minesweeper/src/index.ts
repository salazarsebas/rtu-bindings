...
export const networks = {
  testnet: {
    ...
    contractId: "CA6SO3VN4DJWYGFI4DKJETW5T7J4XKXZD7B3I3J6CCSDKUMNIUNBMZ2A",
  }
} as const
...
export interface Client {
   ...
   */
  reveal_cell: ({row, col}: {row: u32, col: u32}, options?: MethodOptions) => Promise<AssembledTransaction<RevealResult>>
   ...
   */
  get_visible_cell: ({row, col}: {row: u32, col: u32}, options?: MethodOptions) => Promise<AssembledTransaction<VisibleCellState>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        "AAAAAQAAAA1SZXZlYWwgcmVzdWx0AAAAAAAAAAAAAAxSZXZlYWxSZXN1bHQAAAAEAAAAAAAAAA5hZGphY2VudF9taW5lcwAAAAAABAAAAAAAAAAHaXNfbWluZQAAAAABAAAAAAAAAAdtZXNzYWdlAAAAABEAAAAAAAAAB3N1Y2Nlc3MAAAAAAQ==",
        "",
        "AAAAAQAAADtCb2FyZCBjb21wb25lbnQgLSBzdG9yZXMgdGhlIG1pbmUgbGF5b3V0IGFuZCByZXZlYWxlZCBzdGF0ZQAAAAAAAAAADkJvYXJkQ29tcG9uZW50AAAAAAACAAAAAAAAAAVjZWxscwAAAAAAA+oAAAAEAAAAAAAAAAllbnRpdHlfaWQAAAAAAAAE",
        "AAAAAQAAAB9WaXNpYmxlIGNlbGwgc3RhdGUgZm9yIHF1ZXJ5aW5nAAAAAAAAAAAQVmlzaWJsZUNlbGxTdGF0ZQAAAAMAAAAAAAAADmFkamFjZW50X21pbmVzAAAAAAAEAAAAAAAAAAdpc19taW5lAAAAAAEAAAAAAAAAC2lzX3JldmVhbGVkAAAAAAE=",
        "AAAAAQAAABRHYW1lIHN0YXRlIGNvbXBvbmVudAAAAAAAAAASR2FtZVN0YXRlQ29tcG9uZW50AAAAAAADAAAAAAAAAAllbnRpdHlfaWQAAAAAAAAEAAAAAAAAAA5yZXZlYWxlZF9jb3VudAAAAAAABAAAAAAAAAAGc3RhdHVzAAAAAAAE",
        "AAAAAQAAAEtNaW5lIGxheW91dCBjb21wb25lbnQgLSBzdG9yZXMgd2hlcmUgbWluZXMgYXJlIHBsYWNlZCAoaGlkZGVuIGZyb20gcGxheWVycykAAAAAAAAAABNNaW5lTGF5b3V0Q29tcG9uZW50AAAAAAIAAAAAAAAACWVudGl0eV9pZAAAAAAAAAQAAAAAAAAABW1pbmVzAAAAAAAD6gAAAAQ=",
        "AAAAAAAAACtHZXQgdGhlIGJvYXJkIHN0YXRlIChmb3IgZGVidWdnaW5nL3ZpZXdpbmcpAAAAAAlnZXRfYm9hcmQAAAAAAAAAAAAAAQAAA+oAAAAE",
        "AAAAAAAAABpHZXQgdGhlIGN1cnJlbnQgZ2FtZSBzdGF0ZQAAAAAACWdldF9zdGF0ZQAAAAAAAAAAAAABAAAH0AAAAAlHYW1lU3RhdGUAAAA=",
        "AAAAAAAAADRJbml0aWFsaXplIGEgbmV3IGdhbWUgd2l0aCBkZXRlcm1pbmlzdGljIG1pbmUgbGF5b3V0AAAACWluaXRfZ2FtZQAAAAAAAAAAAAABAAAH0AAAAAlHYW1lU3RhdGUAAAA=",
        ...
        "AAAAAAAAABtSZXZlYWwgYSBjZWxsIGF0IChyb3csIGNvbCkAAAAAC3JldmVhbF9jZWxsAAAAAAIAAAAAAAAAA3JvdwAAAAAEAAAAAAAAAANjb2wAAAAABAAAAAEAAAfQAAAADFJldmVhbFJlc3VsdA==",
        "AAAAAAAAACRHZXQgdmlzaWJsZSBzdGF0ZSBvZiBhIHNwZWNpZmljIGNlbGwAAAAQZ2V0X3Zpc2libGVfY2VsbAAAAAIAAAAAAAAAA3JvdwAAAAAEAAAAAAAAAANjb2wAAAAABAAAAAEAAAfQAAAAEFZpc2libGVDZWxsU3RhdGU=",
  ...
  public readonly fromJSON = {
    get_board: this.txFromJSON<Array<u32>>,
        ...
        reveal_cell: this.txFromJSON<RevealResult>,
        get_visible_cell: this.txFromJSON<VisibleCellState>
  }
}