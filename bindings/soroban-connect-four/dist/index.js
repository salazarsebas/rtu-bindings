...
(function (Cell) {
    ...
    Cell[Cell["Player1"] = 1] = "Player1";
    Cell[Cell["Player2"] = 2] = "Player2";
})(Cell || (Cell = {}));
/**
...
export class Client extends ContractClient {
    ...
    constructor(options) {
        super(new ContractSpec(["AAAAAwAAAClDZWxsIHZhbHVlOiAwPUVtcHR5LCAxPVBsYXllcjEsIDI9UGxheWVyMgAAAAAAAAAAAAAEQ2VsbAAAAAMAAAAAAAAABUVtcHR5AAAAAAAAAAAAAAAAAAAHUGxheWVyMQAAAAABAAAAAAAAAAdQbGF5ZXIyAAAAAAI=",
    ...
    fromJSON = {
        ...
        drop_piece: (this.txFromJSON),
        get_winner: (this.txFromJSON),
        reset_game: (this.txFromJSON),
        is_finished: (this.txFromJSON),
        is_valid_column: (this.txFromJSON)
    };
}
