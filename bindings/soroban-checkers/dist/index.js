...
export class Client extends ContractClient {
    ...
    constructor(options) {
        super(new ContractSpec(["",
    ...
    fromJSON = {
        get_board: (this.txFromJSON),
        get_state: (this.txFromJSON),
        init_game: (this.txFromJSON),
        submit_move: (this.txFromJSON),
        get_current_player: (this.txFromJSON)
    };
}
