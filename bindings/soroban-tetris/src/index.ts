...
export const networks = {
  testnet: {
    ...
    contractId: "CAALWXRAZUCHWVDE2WQXW3J7VOHHTOXBR6VTPV253ZKBFTV6BYZX47MT",
  }
} as const
...
export interface Client {
  /**
   * Construct and simulate a drop transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Hard drop
   */
  drop: (options?: MethodOptions) => Promise<AssembledTransaction<u32>>

  /**
   * Construct and simulate a rotate transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Rotate piece
   */
  rotate: (options?: MethodOptions) => Promise<AssembledTransaction<boolean>>
  ...
  /**
   * Construct and simulate a move_down transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Move current piece down (soft drop)
   */
  move_down: (options?: MethodOptions) => Promise<AssembledTransaction<boolean>>

  /**
   * Construct and simulate a move_left transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Move current piece left
   */
  move_left: (options?: MethodOptions) => Promise<AssembledTransaction<boolean>>

  /**
   * Construct and simulate a move_right transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Move current piece right
   */
  move_right: (options?: MethodOptions) => Promise<AssembledTransaction<boolean>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAQAAAAAAAAAAAAAABVBpZWNlAAAAAAAABAAAAAAAAAAIcm90YXRpb24AAAAEAAAAAAAAAAVzaGFwZQAAAAAAB9AAAAAOVGV0cm9taW5vU2hhcGUAAAAAAAAAAAABeAAAAAAAAAUAAAAAAAAAAXkAAAAAAAAF",
        "",
        "AAAAAwAAAAAAAAAAAAAADlRldHJvbWlub1NoYXBlAAAAAAAHAAAAAAAAAAFJAAAAAAAAAAAAAAAAAAABSgAAAAAAAAEAAAAAAAAAAUwAAAAAAAACAAAAAAAAAAFPAAAAAAAAAwAAAAAAAAABUwAAAAAAAAQAAAAAAAAAAVQAAAAAAAAFAAAAAAAAAAFaAAAAAAAABg==",
        "AAAAAAAAAAlIYXJkIGRyb3AAAAAAAAAEZHJvcAAAAAAAAAABAAAABA==",
        "AAAAAAAAAAxSb3RhdGUgcGllY2UAAAAGcm90YXRlAAAAAAAAAAAAAQAAAAE=",
        "AAAAAAAAABFHZXQgY3VycmVudCBzdGF0ZQAAAAAAAAlnZXRfc3RhdGUAAAAAAAAAAAAAAQAAB9AAAAAJR2FtZVN0YXRlAAAA",
        "AAAAAAAAABNJbml0aWFsaXplIHRoZSBnYW1lAAAAAAlpbml0X2dhbWUAAAAAAAAAAAAAAQAAB9AAAAAJR2FtZVN0YXRlAAAA",
        "AAAAAAAAACNNb3ZlIGN1cnJlbnQgcGllY2UgZG93biAoc29mdCBkcm9wKQAAAAAJbW92ZV9kb3duAAAAAAAAAAAAAAEAAAAB",
        "AAAAAAAAABdNb3ZlIGN1cnJlbnQgcGllY2UgbGVmdAAAAAAJbW92ZV9sZWZ0AAAAAAAAAAAAAAEAAAAB",
        "AAAAAAAAABhNb3ZlIGN1cnJlbnQgcGllY2UgcmlnaHQAAAAKbW92ZV9yaWdodAAAAAAAAAAAAAEAAAAB",
        "AAAAAAAAABVVcGRhdGUgdGljayAoZ3Jhdml0eSkAAAAAAAALdXBkYXRlX3RpY2sAAAAAAAAAAAEAAAfQAAAACUdhbWVTdGF0ZQAAAA==",
  ...
  public readonly fromJSON = {
    drop: this.txFromJSON<u32>,
        rotate: this.txFromJSON<boolean>,
        get_state: this.txFromJSON<GameState>,
        init_game: this.txFromJSON<GameState>,
        move_down: this.txFromJSON<boolean>,
        move_left: this.txFromJSON<boolean>,
        move_right: this.txFromJSON<boolean>,
