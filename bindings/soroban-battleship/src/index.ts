...
export const networks = {
  testnet: {
    ...
    contractId: "CCAPWWDWSI2PEHJ6TXXDZ5EOKIPQZAEZQYQ4B6VQ5K74BE3OCPQ7F6VV",
  }
} as const

export type Phase = {tag: "Setup", values: void} | {tag: "Attack", values: void} | {tag: "Finished", values: void};
...
export interface GameState {
  ...
  merkle_root_a: Buffer;
  merkle_root_b: Buffer;
  player_a: string;
  player_b: string;
...
export interface TurnState {
  ...
  has_pending: boolean;
  pending_reveal_x: u32;
  pending_reveal_y: u32;
  phase: Phase;
}


export interface AttackGrid {
  cells: Map<u32, CellResult>;
}

export type CellResult = {tag: "Unknown", values: void} | {tag: "Miss", values: void} | {tag: "Hit", values: void};
...
export interface Client {
   ...
   */
  attack: ({attacker, x, y}: {attacker: string, x: u32, y: u32}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  new_game: ({player_a, player_b}: {player_a: string, player_b: string}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  reveal_cell: ({defender, x, y, value, proof}: {defender: string, x: u32, y: u32, value: u32, proof: OnChainMerkleProof}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  commit_board: ({player, commitment, merkle_root}: {player: string, commitment: Buffer, merkle_root: Buffer}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAgAAAAAAAAAAAAAABVBoYXNlAAAAAAAAAwAAAAAAAAAAAAAABVNldHVwAAAAAAAAAAAAAAAAAAAGQXR0YWNrAAAAAAAAAAAAAAAAAAhGaW5pc2hlZA==",
        "",
        "AAAAAQAAAAAAAAAAAAAACVR1cm5TdGF0ZQAAAAAAAAUAAAAAAAAADmN1cnJlbnRfcGxheWVyAAAAAAATAAAAAAAAAAtoYXNfcGVuZGluZwAAAAABAAAAAAAAABBwZW5kaW5nX3JldmVhbF94AAAABAAAAAAAAAAQcGVuZGluZ19yZXZlYWxfeQAAAAQAAAAAAAAABXBoYXNlAAAAAAAH0AAAAAVQaGFzZQAAAA==",
        "AAAAAQAAAAAAAAAAAAAACkF0dGFja0dyaWQAAAAAAAEAAAAAAAAABWNlbGxzAAAAAAAD7AAAAAQAAAfQAAAACkNlbGxSZXN1bHQAAA==",
        "AAAAAgAAAAAAAAAAAAAACkNlbGxSZXN1bHQAAAAAAAMAAAAAAAAAAAAAAAdVbmtub3duAAAAAAAAAAAAAAAABE1pc3MAAAAAAAAAAAAAAANIaXQA",
        "AAAAAQAAAAAAAAAAAAAAClNoaXBTdGF0dXMAAAAAAAIAAAAAAAAAC3JlbWFpbmluZ19hAAAAAAQAAAAAAAAAC3JlbWFpbmluZ19iAAAAAAQ=",
        "",
        "AAAAAAAAAAAAAAAGYXR0YWNrAAAAAAADAAAAAAAAAAhhdHRhY2tlcgAAABMAAAAAAAAAAXgAAAAAAAAEAAAAAAAAAAF5AAAAAAAABAAAAAA=",
        "AAAAAAAAAAAAAAAIbmV3X2dhbWUAAAACAAAAAAAAAAhwbGF5ZXJfYQAAABMAAAAAAAAACHBsYXllcl9iAAAAEwAAAAA=",
        "AAAAAAAAAAAAAAAJZ2V0X3N0YXRlAAAAAAAAAAAAAAEAAAfQAAAACUdhbWVTdGF0ZQAAAA==",
        "AAAAAAAAAAAAAAALcmV2ZWFsX2NlbGwAAAAABQAAAAAAAAAIZGVmZW5kZXIAAAATAAAAAAAAAAF4AAAAAAAABAAAAAAAAAABeQAAAAAAAAQAAAAAAAAABXZhbHVlAAAAAAAABAAAAAAAAAAFcHJvb2YAAAAAAAfQAAAAEk9uQ2hhaW5NZXJrbGVQcm9vZgAAAAAAAA==",
        "AAAAAAAAAAAAAAAMY29tbWl0X2JvYXJkAAAAAwAAAAAAAAAGcGxheWVyAAAAAAATAAAAAAAAAApjb21taXRtZW50AAAAAAPuAAAAIAAAAAAAAAALbWVya2xlX3Jvb3QAAAAD7gAAACAAAAAA",
  ...
  public readonly fromJSON = {
    attack: this.txFromJSON<null>,
        new_game: this.txFromJSON<null>,
        get_state: this.txFromJSON<GameState>,
        reveal_cell: this.txFromJSON<null>,
        commit_board: this.txFromJSON<null>
  }
}