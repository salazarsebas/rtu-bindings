...
export const networks = {
  testnet: {
    ...
    contractId: "CDTTMHG5JREB7CVDA7PY6I5UH6XDRVLXMWYRVNJRTDXHHKRGE2P52IBT",
  }
} as const

export type Color = {tag: "White", values: void} | {tag: "Black", values: void};
...
export type PieceKind = {tag: "King", values: void} | {tag: "Queen", values: void} | {tag: "Rook", values: void} | {tag: "Bishop", values: void} | {tag: "Knight", values: void} | {tag: "Pawn", values: void};
...
export interface BoardState {
  pieces: Map<u32, Piece>;
  state_hash: Buffer;
}

export type GameStatus = {tag: "Playing", values: void} | {tag: "Checkmate", values: void} | {tag: "Draw", values: void} | {tag: "Resigned", values: void};

export type MoveResult = {tag: "Success", values: void} | {tag: "InvalidProof", values: void} | {tag: "WrongTurn", values: void} | {tag: "GameOver", values: void};
...
export interface Client {
   ...
   * Resign the game
   */
  resign: ({player}: {player: string}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  set_vk: ({vk}: {vk: VerificationKey}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  new_game: ({white, black}: {white: string, black: string}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  get_board: (options?: MethodOptions) => Promise<AssembledTransaction<BoardState>>
   ...
   */
  submit_move: ({player, from, to, proof}: {player: string, from: u32, to: u32, proof: Buffer}, options?: MethodOptions) => Promise<AssembledTransaction<MoveResult>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAgAAAAAAAAAAAAAABUNvbG9yAAAAAAAAAgAAAAAAAAAAAAAABVdoaXRlAAAAAAAAAAAAAAAAAAAFQmxhY2sAAAA=",
        "AAAAAQAAAAAAAAAAAAAABVBpZWNlAAAAAAAAAgAAAAAAAAAFY29sb3IAAAAAAAfQAAAABUNvbG9yAAAAAAAAAAAAAARraW5kAAAH0AAAAAlQaWVjZUtpbmQAAAA=",
        "AAAAAQAAAAAAAAAAAAAACUdhbWVTdGF0ZQAAAAAAAAUAAAAAAAAABWJsYWNrAAAAAAAAEwAAAAAAAAAFYm9hcmQAAAAAAAfQAAAACkJvYXJkU3RhdGUAAAAAAAAAAAAMcHJvb2ZfcmVjb3JkAAAH0AAAAAtQcm9vZlJlY29yZAAAAAAAAAAABHR1cm4AAAfQAAAACVR1cm5TdGF0ZQAAAAAAAAAAAAAFd2hpdGUAAAAAAAAT",
        "AAAAAgAAAAAAAAAAAAAACVBpZWNlS2luZAAAAAAAAAYAAAAAAAAAAAAAAARLaW5nAAAAAAAAAAAAAAAFUXVlZW4AAAAAAAAAAAAAAAAAAARSb29rAAAAAAAAAAAAAAAGQmlzaG9wAAAAAAAAAAAAAAAAAAZLbmlnaHQAAAAAAAAAAAAAAAAABFBhd24=",
        "AAAAAQAAAAAAAAAAAAAACVR1cm5TdGF0ZQAAAAAAAAMAAAAAAAAAB2N1cnJlbnQAAAAAEwAAAAAAAAAKbW92ZV9jb3VudAAAAAAABAAAAAAAAAAGc3RhdHVzAAAAAAfQAAAACkdhbWVTdGF0dXMAAA==",
        "AAAAAQAAAAAAAAAAAAAACkJvYXJkU3RhdGUAAAAAAAIAAAAAAAAABnBpZWNlcwAAAAAD7AAAAAQAAAfQAAAABVBpZWNlAAAAAAAAAAAAAApzdGF0ZV9oYXNoAAAAAAPuAAAAIA==",
        "AAAAAgAAAAAAAAAAAAAACkdhbWVTdGF0dXMAAAAAAAQAAAAAAAAAAAAAAAdQbGF5aW5nAAAAAAAAAAAAAAAACUNoZWNrbWF0ZQAAAAAAAAAAAAAAAAAABERyYXcAAAAAAAAAAAAAAAhSZXNpZ25lZA==",
        "AAAAAgAAAAAAAAAAAAAACk1vdmVSZXN1bHQAAAAAAAQAAAAAAAAAAAAAAAdTdWNjZXNzAAAAAAAAAAAAAAAADEludmFsaWRQcm9vZgAAAAAAAAAAAAAACVdyb25nVHVybgAAAAAAAAAAAAAAAAAACEdhbWVPdmVy",
        "AAAAAQAAAAAAAAAAAAAAC1Byb29mUmVjb3JkAAAAAAIAAAAAAAAACmxhc3RfcHJvb2YAAAAAAA4AAAAAAAAACHZlcmlmaWVkAAAAAQ==",
        "AAAAAAAAAA9SZXNpZ24gdGhlIGdhbWUAAAAABnJlc2lnbgAAAAAAAQAAAAAAAAAGcGxheWVyAAAAAAATAAAAAA==",
        "AAAAAAAAAClTZXQgdGhlIHZlcmlmaWNhdGlvbiBrZXkgKGFkbWluIGZ1bmN0aW9uKQAAAAAAAAZzZXRfdmsAAAAAAAEAAAAAAAAAAnZrAAAAAAfQAAAAD1ZlcmlmaWNhdGlvbktleQAAAAAA",
        "AAAAAAAAABtJbml0aWFsaXplIGEgbmV3IGNoZXNzIGdhbWUAAAAACG5ld19nYW1lAAAAAgAAAAAAAAAFd2hpdGUAAAAAAAATAAAAAAAAAAVibGFjawAAAAAAABMAAAAA",
        "AAAAAAAAABtHZXQgdGhlIGN1cnJlbnQgYm9hcmQgc3RhdGUAAAAACWdldF9ib2FyZAAAAAAAAAAAAAABAAAH0AAAAApCb2FyZFN0YXRlAAA=",
        "AAAAAAAAABpHZXQgdGhlIGN1cnJlbnQgZ2FtZSBzdGF0ZQAAAAAACWdldF9zdGF0ZQAAAAAAAAAAAAABAAAH0AAAAAlHYW1lU3RhdGUAAAA=",
        "AAAAAAAAABtTdWJtaXQgYSBtb3ZlIHdpdGggWksgcHJvb2YAAAAAC3N1Ym1pdF9tb3ZlAAAAAAQAAAAAAAAABnBsYXllcgAAAAAAEwAAAAAAAAAEZnJvbQAAAAQAAAAAAAAAAnRvAAAAAAAEAAAAAAAAAAVwcm9vZgAAAAAAAA4AAAABAAAH0AAAAApNb3ZlUmVzdWx0AAA=",
  ...
  public readonly fromJSON = {
    resign: this.txFromJSON<null>,
        ...
        get_board: this.txFromJSON<BoardState>,
        get_state: this.txFromJSON<GameState>,
        submit_move: this.txFromJSON<MoveResult>
  }
}