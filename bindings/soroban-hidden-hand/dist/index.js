...
export class Client extends ContractClient {
    ...
    constructor(options) {
        super(new ContractSpec(["AAAAAQAAAAAAAAAAAAAAC1RhYmxlQ29uZmlnAAAAAAIAAAAAAAAACWRlY2tfc2l6ZQAAAAAAAAQAAAAAAAAACWhhbmRfc2l6ZQAAAAAAAAQ=",
            ...
            ""]), options);
        this.options = options;
    }
    fromJSON = {
        init_table: (this.txFromJSON),
        verify_deal: (this.txFromJSON)
    };
}
