...
export const networks = {
  testnet: {
    ...
    contractId: "CDMIVUM7KWKDWQ5UVCIOLSKPY3KK3YUFICAYSQT3V2VBJTGKGIIMCH3T",
  }
} as const
...
export interface Client {
   ...
   */
  get_score: (options?: MethodOptions) => Promise<AssembledTransaction<u32>>
   ...
   * - Score set to 0
   */
  init_game: (options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  update_tick: (options?: MethodOptions) => Promise<AssembledTransaction<null>>

  /**
   * Construct and simulate a get_food_pos transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Get the current food position
   */
  get_food_pos: (options?: MethodOptions) => Promise<AssembledTransaction<readonly [i32, i32]>>

  /**
   * Construct and simulate a get_head_pos transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Get the snake's head position
   */
  get_head_pos: (options?: MethodOptions) => Promise<AssembledTransaction<readonly [i32, i32]>>

  /**
   * Construct and simulate a get_grid_size transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Get the grid size
   */
  get_grid_size: (options?: MethodOptions) => Promise<AssembledTransaction<i32>>

  /**
   * Construct and simulate a check_game_over transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Check if the game is over
   */
  check_game_over: (options?: MethodOptions) => Promise<AssembledTransaction<boolean>>

  /**
   * Construct and simulate a change_direction transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   ...
   */
  change_direction: ({direction}: {direction: u32}, options?: MethodOptions) => Promise<AssembledTransaction<boolean>>

  /**
   * Construct and simulate a get_snake_length transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Get the snake's current length (head + segments)
   */
  get_snake_length: (options?: MethodOptions) => Promise<AssembledTransaction<u32>>

  /**
   * Construct and simulate a get_snake_positions transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Get all snake positions (head first, then segments in order)
   */
  get_snake_positions: (options?: MethodOptions) => Promise<AssembledTransaction<Array<readonly [i32, i32]>>>

  /**
   * Construct and simulate a init_game_with_size transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Initialize a new game with custom grid size
   */
  init_game_with_size: ({grid_size}: {grid_size: i32}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        "",
        "AAAAAAAAABVHZXQgdGhlIGN1cnJlbnQgc2NvcmUAAAAAAAAJZ2V0X3Njb3JlAAAAAAAAAAAAAAEAAAAE",
        "",
        "",
        "AAAAAAAAAB1HZXQgdGhlIGN1cnJlbnQgZm9vZCBwb3NpdGlvbgAAAAAAAAxnZXRfZm9vZF9wb3MAAAAAAAAAAQAAA+0AAAACAAAABQAAAAU=",
        "AAAAAAAAAB1HZXQgdGhlIHNuYWtlJ3MgaGVhZCBwb3NpdGlvbgAAAAAAAAxnZXRfaGVhZF9wb3MAAAAAAAAAAQAAA+0AAAACAAAABQAAAAU=",
        "AAAAAAAAABFHZXQgdGhlIGdyaWQgc2l6ZQAAAAAAAA1nZXRfZ3JpZF9zaXplAAAAAAAAAAAAAAEAAAAF",
        "AAAAAAAAABlDaGVjayBpZiB0aGUgZ2FtZSBpcyBvdmVyAAAAAAAAD2NoZWNrX2dhbWVfb3ZlcgAAAAAAAAAAAQAAAAE=",
        "",
        "AAAAAAAAADBHZXQgdGhlIHNuYWtlJ3MgY3VycmVudCBsZW5ndGggKGhlYWQgKyBzZWdtZW50cykAAAAQZ2V0X3NuYWtlX2xlbmd0aAAAAAAAAAABAAAABA==",
        "AAAAAAAAADxHZXQgYWxsIHNuYWtlIHBvc2l0aW9ucyAoaGVhZCBmaXJzdCwgdGhlbiBzZWdtZW50cyBpbiBvcmRlcikAAAATZ2V0X3NuYWtlX3Bvc2l0aW9ucwAAAAAAAAAAAQAAA+oAAAPtAAAAAgAAAAUAAAAF",
        "AAAAAAAAACtJbml0aWFsaXplIGEgbmV3IGdhbWUgd2l0aCBjdXN0b20gZ3JpZCBzaXplAAAAABNpbml0X2dhbWVfd2l0aF9zaXplAAAAAAEAAAAAAAAACWdyaWRfc2l6ZQAAAAAAAAUAAAAA",
  ...
  public readonly fromJSON = {
    get_score: this.txFromJSON<u32>,
        init_game: this.txFromJSON<null>,
        update_tick: this.txFromJSON<null>,
        get_food_pos: this.txFromJSON<readonly [i32, i32]>,
        get_head_pos: this.txFromJSON<readonly [i32, i32]>,
        get_grid_size: this.txFromJSON<i32>,
        check_game_over: this.txFromJSON<boolean>,
        change_direction: this.txFromJSON<boolean>,
        get_snake_length: this.txFromJSON<u32>,
        get_snake_positions: this.txFromJSON<Array<readonly [i32, i32]>>,
        init_game_with_size: this.txFromJSON<null>
  }
}