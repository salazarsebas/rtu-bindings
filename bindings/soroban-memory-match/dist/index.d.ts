...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CAPYWNG6UUCOG4E5Z2P6MQBPTX4E227R3OENACDER3VENRVRMXMTLYB2";
    };
};
...
export declare enum RevealResult {
    Success = 0,
    CardRevealed = 1,
    MatchFound = 2,
    NoMatch = 3,
...
export interface Client {
     ...
     */
    reveal_card: ({ player, position }: {
        player: string;
        position: u32;
    }, options?: MethodOptions) => Promise<AssembledTransaction<RevealInfo>>;
    /**
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        reveal_card: (json: string) => AssembledTransaction<RevealInfo>;
