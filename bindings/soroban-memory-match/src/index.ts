...
export const networks = {
  testnet: {
    ...
    contractId: "CAPYWNG6UUCOG4E5Z2P6MQBPTX4E227R3OENACDER3VENRVRMXMTLYB2",
  }
} as const
...
export interface Client {
   ...
   */
  init_game: ({player}: {player: string}, options?: MethodOptions) => Promise<AssembledTransaction<GameState>>
   ...
   */
  reset_game: ({player}: {player: string}, options?: MethodOptions) => Promise<AssembledTransaction<GameState>>

  /**
   * Construct and simulate a reveal_card transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  reveal_card: ({player, position}: {player: string, position: u32}, options?: MethodOptions) => Promise<AssembledTransaction<RevealInfo>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAwAAAAAAAAAAAAAACUNhcmRTdGF0ZQAAAAAAAAMAAAAAAAAABkhpZGRlbgAAAAAAAAAAAAAAAAAIUmV2ZWFsZWQAAAABAAAAAAAAAAdNYXRjaGVkAAAAAAI=",
        "AAAAAQAAAAAAAAAAAAAACUdhbWVTdGF0ZQAAAAAAAAYAAAAAAAAAC2JvYXJkX3N0YXRlAAAAA+oAAAAEAAAAAAAAAAlnYW1lX292ZXIAAAAAAAABAAAAAAAAAA1tYXRjaGVkX3BhaXJzAAAAAAAABAAAAAAAAAALbW92ZXNfY291bnQAAAAABAAAAAAAAAAOcmV2ZWFsZWRfY291bnQAAAAAAAQAAAAAAAAAC3RvdGFsX3BhaXJzAAAAAAQ=",
        "AAAAAQAAAAAAAAAAAAAAClJldmVhbEluZm8AAAAAAAQAAAAAAAAACHBvc2l0aW9uAAAABAAAAAAAAAAJcG9zaXRpb25zAAAAAAAD6gAAAAQAAAAAAAAABnJlc3VsdAAAAAAH0AAAAAxSZXZlYWxSZXN1bHQAAAAAAAAABXZhbHVlAAAAAAAABA==",
        "AAAAAwAAAAAAAAAAAAAADFJldmVhbFJlc3VsdAAAAAUAAAAAAAAAB1N1Y2Nlc3MAAAAAAAAAAAAAAAAMQ2FyZFJldmVhbGVkAAAAAQAAAAAAAAAKTWF0Y2hGb3VuZAAAAAAAAgAAAAAAAAAHTm9NYXRjaAAAAAADAAAAAAAAAAhHYW1lT3ZlcgAAAAQ=",
        "AAAAAQAAAAAAAAAAAAAADUNhcmRDb21wb25lbnQAAAAAAAAFAAAAAAAAAAdjYXJkX2lkAAAAAAQAAAAAAAAACWVudGl0eV9pZAAAAAAAAAQAAAAAAAAACHBvc2l0aW9uAAAABAAAAAAAAAAFc3RhdGUAAAAAAAfQAAAACUNhcmRTdGF0ZQAAAAAAAAAAAAAFdmFsdWUAAAAAAAAE",
        "",
        "AAAAAQAAAAAAAAAAAAAADkJvYXJkQ29tcG9uZW50AAAAAAAFAAAAAAAAAAVjYXJkcwAAAAAAA+oAAAAEAAAAAAAAAAllbnRpdHlfaWQAAAAAAAAEAAAAAAAAAA1tYXRjaGVkX3BhaXJzAAAAAAAABAAAAAAAAAAOcmV2ZWFsZWRfY2FyZHMAAAAAA+oAAAAEAAAAAAAAAAt0b3RhbF9wYWlycwAAAAAE",
        "AAAAAQAAAAAAAAAAAAAAEkdhbWVTdGF0ZUNvbXBvbmVudAAAAAAABQAAAAAAAAAKY2FuX3JldmVhbAAAAAAAAQAAAAAAAAAJZW50aXR5X2lkAAAAAAAABAAAAAAAAAAJZ2FtZV9vdmVyAAAAAAAAAQAAAAAAAAALbW92ZXNfY291bnQAAAAABAAAAAAAAAAGcGxheWVyAAAAAAAT",
        "AAAAAAAAAAAAAAAJaW5pdF9nYW1lAAAAAAAAAQAAAAAAAAAGcGxheWVyAAAAAAATAAAAAQAAB9AAAAAJR2FtZVN0YXRlAAAA",
        "AAAAAAAAAAAAAAAKcmVzZXRfZ2FtZQAAAAAAAQAAAAAAAAAGcGxheWVyAAAAAAATAAAAAQAAB9AAAAAJR2FtZVN0YXRlAAAA",
        "AAAAAAAAAAAAAAALcmV2ZWFsX2NhcmQAAAAAAgAAAAAAAAAGcGxheWVyAAAAAAATAAAAAAAAAAhwb3NpdGlvbgAAAAQAAAABAAAH0AAAAApSZXZlYWxJbmZvAAA=",
  ...
  public readonly fromJSON = {
    init_game: this.txFromJSON<GameState>,
        ...
        reveal_card: this.txFromJSON<RevealInfo>,
