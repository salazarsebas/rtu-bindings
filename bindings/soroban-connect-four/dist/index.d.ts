...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CAT4KB2Y4LRGXFF2SIW6Z4UAGKNFYVDOJOFTNRWF3AM2ZJUW5YLGSVO2";
    };
};
/**
...
export interface Client {
     ...
     */
    init_game: ({ player_one, player_two }: {
        player_one: string;
        player_two: string;
    }, options?: MethodOptions) => Promise<AssembledTransaction<GameState>>;
    /**
    ...
    drop_piece: ({ player, column }: {
        player: string;
        column: u32;
    }, options?: MethodOptions) => Promise<AssembledTransaction<DropResult>>;
    /**
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        drop_piece: (json: string) => AssembledTransaction<DropResult>;
        get_winner: (json: string) => AssembledTransaction<Option<string>>;
        reset_game: (json: string) => AssembledTransaction<GameState>;
        is_finished: (json: string) => AssembledTransaction<boolean>;
        is_valid_column: (json: string) => AssembledTransaction<boolean>;
    };
}
