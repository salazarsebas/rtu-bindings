...
export const networks = {
  testnet: {
    ...
    contractId: "CC6E73MMVMCOMDWNKASAMMXTA5UCCSNOEMVUWR7YGQ3KRDMTYAMMCSTX",
  }
} as const
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAABQAAAAAAAAAAAAAADkluY3JlbWVudEV2ZW50AAAAAAACAAAAB0NPVU5URVIAAAAACWluY3JlbWVudAAAAAAAAAEAAAAAAAAABWNvdW50AAAAAAAABAAAAAAAAAAA",
