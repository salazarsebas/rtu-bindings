...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CBNZJLQK5VOIU6AOMJZEKECONMJR4KHDKTOKZ3KKKZV5UIKDDORBZMGV";
    };
};
/**
...
export declare const CheckersError: {
    /**
...
export interface Client {
     ...
     */
    submit_move: ({ player, from_row, from_col, to_row, to_col }: {
        player: string;
        from_row: u32;
        from_col: u32;
        to_row: u32;
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        get_board: (json: string) => AssembledTransaction<Result<BoardState, import("@stellar/stellar-sdk/contract").ErrorMessage>>;
        get_state: (json: string) => AssembledTransaction<Result<GameState, import("@stellar/stellar-sdk/contract").ErrorMessage>>;
        init_game: (json: string) => AssembledTransaction<Result<void, import("@stellar/stellar-sdk/contract").ErrorMessage>>;
        submit_move: (json: string) => AssembledTransaction<Result<void, import("@stellar/stellar-sdk/contract").ErrorMessage>>;
        get_current_player: (json: string) => AssembledTransaction<Result<string, import("@stellar/stellar-sdk/contract").ErrorMessage>>;
    };
}
