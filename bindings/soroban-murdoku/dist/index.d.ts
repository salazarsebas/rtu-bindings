...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CDVKQVARXJP6HIY2MEBK2V6DPCZH4J62N3O7XVUCA4FGN2ZXKOZ4MXM6";
    };
};
/**
 ...
 */
export declare const PuzzleError: {
    1: {
        message: string;
    };
    2: {
...
export interface Client {
     ...
     */
    list_puzzles: ({ offset, limit }: {
        offset: u32;
        limit: u32;
    }, options?: MethodOptions) => Promise<AssembledTransaction<Array<PuzzleSummary>>>;
    /**
     ...
     */
    place_suspect: ({ player, puzzle_id, x, y, suspect_idx }: {
        player: string;
        puzzle_id: u32;
        x: u32;
        y: u32;
        suspect_idx: u32;
    }, options?: MethodOptions) => Promise<AssembledTransaction<MoveResult>>;
    /**
     ...
     */
    submit_puzzle: ({ caller, grid_size, suspects, clues, solution, metadata }: {
        caller: string;
        grid_size: u32;
        suspects: Array<string>;
        clues: Array<Clue>;
     ...
     */
    remove_suspect: ({ player, puzzle_id, x, y }: {
        player: string;
        puzzle_id: u32;
        x: u32;
        y: u32;
     ...
     */
    revoke_session: ({ player, puzzle_id }: {
        player: string;
        puzzle_id: u32;
    }, options?: MethodOptions) => Promise<AssembledTransaction<null>>;
    /**
     ...
     */
    get_player_state: ({ player, puzzle_id }: {
        player: string;
        puzzle_id: u32;
    }, options?: MethodOptions) => Promise<AssembledTransaction<PlayerState>>;
    /**
     ...
     */
    authorize_session: ({ player, puzzle_id, session_key, expires_at_ledger }: {
        player: string;
        puzzle_id: u32;
        session_key: Buffer;
     ...
     */
    deactivate_puzzle: ({ caller, puzzle_id }: {
        caller: string;
        puzzle_id: u32;
    }, options?: MethodOptions) => Promise<AssembledTransaction<null>>;
}
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        get_puzzle: (json: string) => AssembledTransaction<Puzzle>;
        start_game: (json: string) => AssembledTransaction<null>;
        list_puzzles: (json: string) => AssembledTransaction<PuzzleSummary[]>;
        place_suspect: (json: string) => AssembledTransaction<MoveResult>;
        submit_puzzle: (json: string) => AssembledTransaction<number>;
        remove_suspect: (json: string) => AssembledTransaction<MoveResult>;
        revoke_session: (json: string) => AssembledTransaction<null>;
        get_player_state: (json: string) => AssembledTransaction<PlayerState>;
        get_puzzle_count: (json: string) => AssembledTransaction<number>;
        authorize_session: (json: string) => AssembledTransaction<null>;
        deactivate_puzzle: (json: string) => AssembledTransaction<null>;
    };
}
