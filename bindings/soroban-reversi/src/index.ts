...
export const networks = {
  testnet: {
    ...
    contractId: "CCE4NZWAIRGJPBHR2DYQ7RT3OH2VDOPU6AZ2T2YIOXM6RC7Z7IC6KVYX",
  }
} as const
...
export interface Client {
   ...
   */
  get_score: (options?: MethodOptions) => Promise<AssembledTransaction<ScoreState>>
   ...
   */
  init_game: ({player_one, player_two}: {player_one: string, player_two: string}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  submit_move: ({player, row, col}: {player: string, row: u32, col: u32}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAQAAAAAAAAAAAAAACUdhbWVTdGF0ZQAAAAAAAAMAAAAAAAAADmN1cnJlbnRfcGxheWVyAAAAAAAEAAAAAAAAAApwYXNzX2NvdW50AAAAAAAEAAAAAAAAAAZzdGF0dXMAAAAAAAQ=",
        "AAAAAQAAAAAAAAAAAAAACkJvYXJkU3RhdGUAAAAAAAMAAAAAAAAABWNlbGxzAAAAAAAD6gAAAAQAAAAAAAAABmhlaWdodAAAAAAABAAAAAAAAAAFd2lkdGgAAAAAAAAE",
        "AAAAAQAAAAAAAAAAAAAAClNjb3JlU3RhdGUAAAAAAAMAAAAAAAAAC2JsYWNrX2NvdW50AAAAAAQAAAAAAAAAC3doaXRlX2NvdW50AAAAAAQAAAAAAAAABndpbm5lcgAAAAAABA==",
        "",
        "",
        "AAAAAQAAAAAAAAAAAAAADkJvYXJkQ29tcG9uZW50AAAAAAADAAAAAAAAAAVjZWxscwAAAAAAA+oAAAAEAAAAAAAAAAZoZWlnaHQAAAAAAAQAAAAAAAAABXdpZHRoAAAAAAAABA==",
        "AAAAAQAAAAAAAAAAAAAADlNjb3JlQ29tcG9uZW50AAAAAAACAAAAAAAAAAtibGFja19jb3VudAAAAAAEAAAAAAAAAAt3aGl0ZV9jb3VudAAAAAAE",
        "AAAAAQAAAAAAAAAAAAAAE0dhbWVTdGF0dXNDb21wb25lbnQAAAAAAQAAAAAAAAAGc3RhdHVzAAAAAAAE",
        "AAAAAAAAAAAAAAAJZ2V0X2JvYXJkAAAAAAAAAAAAAAEAAAfQAAAACkJvYXJkU3RhdGUAAA==",
        "AAAAAAAAAAAAAAAJZ2V0X3Njb3JlAAAAAAAAAAAAAAEAAAfQAAAAClNjb3JlU3RhdGUAAA==",
        "AAAAAAAAAAAAAAAJZ2V0X3N0YXRlAAAAAAAAAAAAAAEAAAfQAAAACUdhbWVTdGF0ZQAAAA==",
        "AAAAAAAAAAAAAAAJaW5pdF9nYW1lAAAAAAAAAgAAAAAAAAAKcGxheWVyX29uZQAAAAAAEwAAAAAAAAAKcGxheWVyX3R3bwAAAAAAEwAAAAA=",
        "AAAAAAAAAAAAAAALc3VibWl0X21vdmUAAAAAAwAAAAAAAAAGcGxheWVyAAAAAAATAAAAAAAAAANyb3cAAAAABAAAAAAAAAADY29sAAAAAAQAAAAA",
  ...
  public readonly fromJSON = {
    get_board: this.txFromJSON<BoardState>,
        get_score: this.txFromJSON<ScoreState>,
