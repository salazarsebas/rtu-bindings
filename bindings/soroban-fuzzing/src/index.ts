...
export const networks = {
  testnet: {
    ...
    contractId: "CD5GI7C5YAYJB6IP4KS75RAA7WGGLEHSW462NDX7WY5DDQP4FSMXHDQN",
  }
} as const
...
export interface Client {
   ...
   */
  claim: ({claimant, amount}: {claimant: string, amount: i128}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAgAAAAAAAAAAAAAAB0RhdGFLZXkAAAAAAgAAAAAAAAAAAAAABEluaXQAAAAAAAAAAAAAAAdCYWxhbmNlAA==",
        ...
        "AAAAAAAAAAAAAAAFY2xhaW0AAAAAAAACAAAAAAAAAAhjbGFpbWFudAAAABMAAAAAAAAABmFtb3VudAAAAAAACwAAAAA=",
