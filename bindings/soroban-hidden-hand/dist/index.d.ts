...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CAY3PCEZD5O7ZUOOSW3MRQIWPJLDKWS3AS3NJXBK2IX6RVOVNJWMDE62";
    };
};
...
export interface Client {
     ...
     */
    init_table: ({ deck_size, hand_size }: {
        deck_size: u32;
        hand_size: u32;
    }, options?: MethodOptions) => Promise<AssembledTransaction<TableConfig>>;
    /**
     ...
     */
    verify_deal: ({ player, deck_root, hand_commitment, proof }: {
        player: string;
        deck_root: Buffer;
        hand_commitment: Buffer;
        proof: Groth16Proof;
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        init_table: (json: string) => AssembledTransaction<TableConfig>;
        verify_deal: (json: string) => AssembledTransaction<boolean>;
    };
}
