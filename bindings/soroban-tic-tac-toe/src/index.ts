...
export const networks = {
  testnet: {
    ...
    contractId: "CCYCLEJ6WPWNXYAQRMYMAY42E52NR7FEXB42P3T4BMJPJKAXD6QW2WDY",
  }
} as const
...
export interface Client {
   ...
   */
  init_game: ({player_x, player_o}: {player_x: string, player_o: string}, options?: MethodOptions) => Promise<AssembledTransaction<GameState>>
   ...
   */
  make_move: ({player, position}: {player: string, position: u32}, options?: MethodOptions) => Promise<AssembledTransaction<MoveResult>>
  ...
  /**
   * Construct and simulate a is_valid_move transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Return true if `position` is a legal move right now.
   */
  is_valid_move: ({position}: {position: u32}, options?: MethodOptions) => Promise<AssembledTransaction<boolean>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAQAAAAAAAAAAAAAACUdhbWVTdGF0ZQAAAAAAAAYAAAAAAAAABWNlbGxzAAAAAAAD6gAAAAQAAAAAAAAACWlzX3hfdHVybgAAAAAAAAEAAAAAAAAACm1vdmVfY291bnQAAAAAAAQAAAAAAAAACHBsYXllcl9vAAAAEwAAAAAAAAAIcGxheWVyX3gAAAATAAAAAAAAAAZzdGF0dXMAAAAAAAQ=",
        "AAAAAQAAAAAAAAAAAAAACk1vdmVSZXN1bHQAAAAAAAMAAAAAAAAACmdhbWVfc3RhdGUAAAAAB9AAAAAJR2FtZVN0YXRlAAAAAAAAAAAAAAdtZXNzYWdlAAAAABEAAAAAAAAAB3N1Y2Nlc3MAAAAAAQ==",
        "AAAAAQAAAHJCb2FyZCBzdGF0ZTogOSBjZWxscyB3aGVyZSAwID0gZW1wdHksIDEgPSBYLCAyID0gTy4KVXNlcyBpbXBsX3JpY2hfY29tcG9uZW50ISBiZWNhdXNlIFZlYzx1MzI+IHJlcXVpcmVzIFhEUiBjb2RlYy4AAAAAAAAAAAAFQm9hcmQAAAAAAAABAAAAAAAAAAVjZWxscwAAAAAAA+oAAAAE",
        "AAAAAQAAAF1Cb3RoIHBsYXllcnMnIHdhbGxldCBhZGRyZXNzZXMuClVzZXMgaW1wbF9yaWNoX2NvbXBvbmVudCEgYmVjYXVzZSBBZGRyZXNzIHJlcXVpcmVzIFhEUiBjb2RlYy4AAAAAAAAAAAAAB1BsYXllcnMAAAAAAgAAAAAAAAAIcGxheWVyX28AAAATAAAAAAAAAAhwbGF5ZXJfeAAAABM=",
        "AAAAAQAAAERUdXJuIGFuZCBnYW1lLW92ZXIgc3RhdGUg4oCUIHBsYWluIGZpeGVkLXNpemUgZmllbGRzOyBubyBYRFIgbmVlZGVkLgAAAAAAAAAJVHVyblN0YXRlAAAAAAAAAwAAAAAAAAAJaXNfeF90dXJuAAAAAAAAAQAAAAAAAAAKbW92ZV9jb3VudAAAAAAABAAAAAAAAAAGc3RhdHVzAAAAAAAE",
        "AAAAAAAAAB5SZXR1cm4gdGhlIGN1cnJlbnQgZ2FtZSBzdGF0ZS4AAAAAAAlnZXRfc3RhdGUAAAAAAAAAAAAAAQAAB9AAAAAJR2FtZVN0YXRlAAAA",
        "AAAAAAAAADVJbml0aWFsaXNlIGEgbmV3IGdhbWUsIGRpc2NhcmRpbmcgYW55IHByZXZpb3VzIHN0YXRlLgAAAAAAAAlpbml0X2dhbWUAAAAAAAACAAAAAAAAAAhwbGF5ZXJfeAAAABMAAAAAAAAACHBsYXllcl9vAAAAEwAAAAEAAAfQAAAACUdhbWVTdGF0ZQAAAA==",
        "AAAAAAAAADlBdHRlbXB0IHRvIHBsYWNlIHRoZSBjYWxsZXIncyBtYXJrIGF0IGBwb3NpdGlvbmAgKDDigJM4KS4AAAAAAAAJbWFrZV9tb3ZlAAAAAAAAAgAAAAAAAAAGcGxheWVyAAAAAAATAAAAAAAAAAhwb3NpdGlvbgAAAAQAAAABAAAH0AAAAApNb3ZlUmVzdWx0AAA=",
        "AAAAAAAAAEdSZXR1cm4gdGhlIHdpbm5lcidzIGFkZHJlc3MsIG9yIGBOb25lYCBpZiB0aGUgZ2FtZSBpcyBvbmdvaW5nIG9yIGRyYXduLgAAAAAKZ2V0X3dpbm5lcgAAAAAAAAAAAAEAAAPoAAAAEw==",
        "AAAAAAAAACpSZXNldCB0aGUgYm9hcmQgYnV0IGtlZXAgdGhlIHNhbWUgcGxheWVycy4AAAAAAApyZXNldF9nYW1lAAAAAAAAAAAAAQAAB9AAAAAJR2FtZVN0YXRlAAAA",
        "AAAAAAAAADRSZXR1cm4gdHJ1ZSBpZiBgcG9zaXRpb25gIGlzIGEgbGVnYWwgbW92ZSByaWdodCBub3cuAAAADWlzX3ZhbGlkX21vdmUAAAAAAAABAAAAAAAAAAhwb3NpdGlvbgAAAAQAAAABAAAAAQ==",
