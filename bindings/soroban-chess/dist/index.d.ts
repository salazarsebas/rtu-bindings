...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CDTTMHG5JREB7CVDA7PY6I5UH6XDRVLXMWYRVNJRTDXHHKRGE2P52IBT";
    };
};
export type Color = {
    tag: "White";
...
export interface Client {
     ...
     */
    submit_move: ({ player, from, to, proof }: {
        player: string;
        from: u32;
        to: u32;
        proof: Buffer;
