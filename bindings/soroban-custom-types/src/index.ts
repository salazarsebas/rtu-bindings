...
export const networks = {
  testnet: {
    ...
    contractId: "CCWXFYRYUNHQWFLAC63GB4IF57TTMMWAO5SSMOLWRPPYR3UYE6SDBHXO",
  }
} as const
...
export interface Client {
   ...
   */
  get_state: (options?: MethodOptions) => Promise<AssembledTransaction<State>>
   ...
   */
  increment: ({incr}: {incr: u32}, options?: MethodOptions) => Promise<AssembledTransaction<u32>>
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAQAAAAAAAAAAAAAABVN0YXRlAAAAAAAAAgAAAAAAAAAFY291bnQAAAAAAAAEAAAAAAAAAAlsYXN0X2luY3IAAAAAAAAE",
        ...
        "AAAAAAAAAEBJbmNyZW1lbnQgaW5jcmVtZW50cyBhbiBpbnRlcm5hbCBjb3VudGVyLCBhbmQgcmV0dXJucyB0aGUgdmFsdWUuAAAACWluY3JlbWVudAAAAAAAAAEAAAAAAAAABGluY3IAAAAEAAAAAQAAAAQ=" ]),
      options
    )
  }
