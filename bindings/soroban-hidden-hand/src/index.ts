...
export const networks = {
  testnet: {
    ...
    contractId: "CAY3PCEZD5O7ZUOOSW3MRQIWPJLDKWS3AS3NJXBK2IX6RVOVNJWMDE62",
  }
} as const
...
export interface Client {
  /**
   * Construct and simulate a init_table transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Configure the table with a standard hidden-card circuit spec.
   */
  init_table: ({deck_size, hand_size}: {deck_size: u32, hand_size: u32}, options?: MethodOptions) => Promise<AssembledTransaction<TableConfig>>

  /**
   * Construct and simulate a verify_deal transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Verify a deal proof against the frozen hidden-cards layout.
   */
  verify_deal: ({player, deck_root, hand_commitment, proof}: {player: string, deck_root: Buffer, hand_commitment: Buffer, proof: Groth16Proof}, options?: MethodOptions) => Promise<AssembledTransaction<boolean>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAQAAAAAAAAAAAAAAC1RhYmxlQ29uZmlnAAAAAAIAAAAAAAAACWRlY2tfc2l6ZQAAAAAAAAQAAAAAAAAACWhhbmRfc2l6ZQAAAAAAAAQ=",
        "AAAAAAAAAD1Db25maWd1cmUgdGhlIHRhYmxlIHdpdGggYSBzdGFuZGFyZCBoaWRkZW4tY2FyZCBjaXJjdWl0IHNwZWMuAAAAAAAACmluaXRfdGFibGUAAAAAAAIAAAAAAAAACWRlY2tfc2l6ZQAAAAAAAAQAAAAAAAAACWhhbmRfc2l6ZQAAAAAAAAQAAAABAAAH0AAAAAtUYWJsZUNvbmZpZwA=",
        "",
  ...
  public readonly fromJSON = {
    init_table: this.txFromJSON<TableConfig>,
        verify_deal: this.txFromJSON<boolean>
  }
}