...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CCA7TE6AUGX5EIW6UAVHVTFSFVDQ77T37W6NUWPRLWMLVV25V7BWB66P";
    };
};
export type Phase = {
    tag: "Committing";
...
export interface Client {
     ...
     */
    new_match: ({ player_a, player_b, best_of }: {
        player_a: string;
        player_b: string;
        best_of: u32;
    }, options?: MethodOptions) => Promise<AssembledTransaction<null>>;
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        reveal: (json: string) => AssembledTransaction<null>;
        get_score: (json: string) => AssembledTransaction<ScoreBoard>;
        get_state: (json: string) => AssembledTransaction<MatchState>;
        new_match: (json: string) => AssembledTransaction<null>;
