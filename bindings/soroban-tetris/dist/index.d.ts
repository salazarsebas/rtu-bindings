...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CAALWXRAZUCHWVDE2WQXW3J7VOHHTOXBR6VTPV253ZKBFTV6BYZX47MT";
    };
};
...
export declare enum TetrominoShape {
    I = 0,
    J = 1,
    L = 2,
    O = 3,
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        drop: (json: string) => AssembledTransaction<number>;
        rotate: (json: string) => AssembledTransaction<boolean>;
        get_state: (json: string) => AssembledTransaction<GameState>;
        init_game: (json: string) => AssembledTransaction<GameState>;
        move_down: (json: string) => AssembledTransaction<boolean>;
        move_left: (json: string) => AssembledTransaction<boolean>;
        move_right: (json: string) => AssembledTransaction<boolean>;
        update_tick: (json: string) => AssembledTransaction<GameState>;
    };
}
