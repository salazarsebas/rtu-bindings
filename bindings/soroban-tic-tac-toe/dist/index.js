...
export class Client extends ContractClient {
    ...
    constructor(options) {
        super(new ContractSpec(["AAAAAQAAAAAAAAAAAAAACUdhbWVTdGF0ZQAAAAAAAAYAAAAAAAAABWNlbGxzAAAAAAAD6gAAAAQAAAAAAAAACWlzX3hfdHVybgAAAAAAAAEAAAAAAAAACm1vdmVfY291bnQAAAAAAAQAAAAAAAAACHBsYXllcl9vAAAAEwAAAAAAAAAIcGxheWVyX3gAAAATAAAAAAAAAAZzdGF0dXMAAAAAAAQ=",
    ...
    fromJSON = {
        ...
        make_move: (this.txFromJSON),
        get_winner: (this.txFromJSON),
        reset_game: (this.txFromJSON),
        is_valid_move: (this.txFromJSON)
    };
}
