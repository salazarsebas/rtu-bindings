...
export class Client extends ContractClient {
    ...
    constructor(options) {
        super(new ContractSpec(["",
    ...
    fromJSON = {
        ...
        update_tick: (this.txFromJSON),
        get_food_pos: (this.txFromJSON),
        get_head_pos: (this.txFromJSON),
        get_grid_size: (this.txFromJSON),
        check_game_over: (this.txFromJSON),
        change_direction: (this.txFromJSON),
        get_snake_length: (this.txFromJSON),
        get_snake_positions: (this.txFromJSON),
        init_game_with_size: (this.txFromJSON)
    };
}
