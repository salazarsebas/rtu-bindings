...
export const networks = {
  testnet: {
    ...
    contractId: "CAGHKWNQWLGTHSRWNP4DA3MZ5UEVUQULQKCYN7UOPRQBYJHMN5KUHSXB",
  }
} as const
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAABAAAAAAAAAAAAAAABUVycm9yAAAAAAAAAQAAAAAAAAAMTGltaXRSZWFjaGVkAAAAAQ==",
        "AAAAAAAAAHtJbmNyZW1lbnQgaW5jcmVtZW50cyBhbiBpbnRlcm5hbCBjb3VudGVyLCBhbmQgcmV0dXJucyB0aGUgdmFsdWUuIEVycm9ycwppZiB0aGUgdmFsdWUgaXMgYXR0ZW1wdGVkIHRvIGJlIGluY3JlbWVudGVkIHBhc3QgNS4AAAAACWluY3JlbWVudAAAAAAAAAAAAAABAAAD6QAAAAQAAAAD" ]),
      options
    )
  }
