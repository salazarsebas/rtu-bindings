...
(function (MoveResult) {
    MoveResult[MoveResult["Ok"] = 0] = "Ok";
    MoveResult[MoveResult["RowConflict"] = 1] = "RowConflict";
    MoveResult[MoveResult["ColConflict"] = 2] = "ColConflict";
    MoveResult[MoveResult["CellOccupied"] = 3] = "CellOccupied";
    MoveResult[MoveResult["GameAlreadySolved"] = 4] = "GameAlreadySolved";
    MoveResult[MoveResult["InvalidCoordinates"] = 5] = "InvalidCoordinates";
...
export var ComponentStorage;
(function (ComponentStorage) {
    ComponentStorage[ComponentStorage["Table"] = 0] = "Table";
    ComponentStorage[ComponentStorage["Sparse"] = 1] = "Sparse";
...
(function (AuthMethod) {
    AuthMethod[AuthMethod["Direct"] = 0] = "Direct";
    AuthMethod[AuthMethod["Session"] = 1] = "Session";
    AuthMethod[AuthMethod["Passkey"] = 2] = "Passkey";
})(AuthMethod || (AuthMethod = {}));
/**
 * Supported intent signer kinds for the account kernel.
 */
export var IntentSigner;
(function (IntentSigner) {
    IntentSigner[IntentSigner["Direct"] = 0] = "Direct";
    IntentSigner[IntentSigner["Session"] = 1] = "Session";
    IntentSigner[IntentSigner["Passkey"] = 2] = "Passkey";
})(IntentSigner || (IntentSigner = {}));
/**
 * Signature container for intent verification.
 */
export var IntentProofKind;
(function (IntentProofKind) {
    IntentProofKind[IntentProofKind["None"] = 0] = "None";
    IntentProofKind[IntentProofKind["Secp256r1"] = 1] = "Secp256r1";
})(IntentProofKind || (IntentProofKind = {}));
/**
 * Frozen identifier for a pre-built game circuit family.
 */
export var CircuitId;
(function (CircuitId) {
    CircuitId[CircuitId["HiddenCards"] = 1] = "HiddenCards";
    CircuitId[CircuitId["FogOfWar"] = 2] = "FogOfWar";
    CircuitId[CircuitId["FairDice"] = 3] = "FairDice";
    CircuitId[CircuitId["SealedBid"] = 4] = "SealedBid";
})(CircuitId || (CircuitId = {}));
/**
...
export class Client extends ContractClient {
    ...
    constructor(options) {
        super(new ContractSpec(["",
    ...
    fromJSON = {
        get_puzzle: (this.txFromJSON),
        start_game: (this.txFromJSON),
        list_puzzles: (this.txFromJSON),
        place_suspect: (this.txFromJSON),
        submit_puzzle: (this.txFromJSON),
        remove_suspect: (this.txFromJSON),
        revoke_session: (this.txFromJSON),
        get_player_state: (this.txFromJSON),
        get_puzzle_count: (this.txFromJSON),
        authorize_session: (this.txFromJSON),
        deactivate_puzzle: (this.txFromJSON)
    };
}
