...
export const networks = {
  testnet: {
    ...
    contractId: "CAFJ33L24A2R4Z447F4MJEPBU6FPHGVC7AAUKXFGXMAJSUEDRTF2BKOP",
  }
} as const
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAAHdXBncmFkZQAAAAABAAAAAAAAAA1uZXdfd2FzbV9oYXNoAAAAAAAD7gAAACAAAAAA",
        ...
        "AAAAAAAAAAAAAAAOaGFuZGxlX3VwZ3JhZGUAAAAAAAAAAAAA" ]),
      options
    )
  }
  public readonly fromJSON = {
    upgrade: this.txFromJSON<null>,
        ...
        new_v2_fn: this.txFromJSON<u32>,
        handle_upgrade: this.txFromJSON<null>
  }
}