...
import type { u32, i32, u64, u128, i128, Option } from "@stellar/stellar-sdk/contract";
...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CBXOSKHYMU3OSANHIORRZIHQ5DC4OZDZAZ65CEKGQPOMQE4HKP7FOYBS";
    };
};
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        shoot: (json: string) => AssembledTransaction<null>;
        get_score: (json: string) => AssembledTransaction<number>;
        init_game: (json: string) => AssembledTransaction<null>;
        rotate_ship: (json: string) => AssembledTransaction<null>;
        thrust_ship: (json: string) => AssembledTransaction<null>;
        update_tick: (json: string) => AssembledTransaction<null>;
        get_game_state: (json: string) => AssembledTransaction<GameState>;
