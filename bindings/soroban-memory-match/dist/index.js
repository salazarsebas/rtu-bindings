...
(function (CardState) {
    ...
    CardState[CardState["Revealed"] = 1] = "Revealed";
    CardState[CardState["Matched"] = 2] = "Matched";
})(CardState || (CardState = {}));
export var RevealResult;
(function (RevealResult) {
    RevealResult[RevealResult["Success"] = 0] = "Success";
    RevealResult[RevealResult["CardRevealed"] = 1] = "CardRevealed";
    RevealResult[RevealResult["MatchFound"] = 2] = "MatchFound";
    RevealResult[RevealResult["NoMatch"] = 3] = "NoMatch";
    RevealResult[RevealResult["GameOver"] = 4] = "GameOver";
...
export class Client extends ContractClient {
    ...
    constructor(options) {
        super(new ContractSpec(["AAAAAwAAAAAAAAAAAAAACUNhcmRTdGF0ZQAAAAAAAAMAAAAAAAAABkhpZGRlbgAAAAAAAAAAAAAAAAAIUmV2ZWFsZWQAAAABAAAAAAAAAAdNYXRjaGVkAAAAAAI=",
    ...
    fromJSON = {
        ...
        reveal_card: (this.txFromJSON),
        get_game_state: (this.txFromJSON)
    };
}
