...
export const networks = {
  testnet: {
    ...
    contractId: "CCA7TE6AUGX5EIW6UAVHVTFSFVDQ77T37W6NUWPRLWMLVV25V7BWB66P",
  }
} as const

export type Phase = {tag: "Committing", values: void} | {tag: "Revealing", values: void} | {tag: "Resolved", values: void};
...
export interface GameState {
  ...
  choice_b: u32;
  commit_ledger: u32;
  has_commit_a: boolean;
  has_commit_b: boolean;
  hash_a: Buffer;
  hash_b: Buffer;
...
export interface Client {
   ...
   */
  commit: ({player, hash}: {player: string, hash: Buffer}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  reveal: ({player, choice, salt}: {player: string, choice: u32, salt: Buffer}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  get_score: (options?: MethodOptions) => Promise<AssembledTransaction<ScoreBoard>>
   ...
   */
  get_state: (options?: MethodOptions) => Promise<AssembledTransaction<MatchState>>

  /**
   * Construct and simulate a new_match transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  new_match: ({player_a, player_b, best_of}: {player_a: string, player_b: string, best_of: u32}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  claim_timeout: ({player}: {player: string}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAgAAAAAAAAAAAAAABVBoYXNlAAAAAAAAAwAAAAAAAAAAAAAACkNvbW1pdHRpbmcAAAAAAAAAAAAAAAAACVJldmVhbGluZwAAAAAAAAAAAAAAAAAACFJlc29sdmVk",
        "AAAAAwAAAAAAAAAAAAAABkNob2ljZQAAAAAAAwAAAAAAAAAEUm9jawAAAAAAAAAAAAAABVBhcGVyAAAAAAAAAQAAAAAAAAAIU2Npc3NvcnMAAAAC",
        "",
        "AAAAAQAAAAAAAAAAAAAACk1hdGNoU3RhdGUAAAAAAAMAAAAAAAAABXBoYXNlAAAAAAAH0AAAAAVQaGFzZQAAAAAAAAAAAAAFcm91bmQAAAAAAAAEAAAAAAAAAAZ3aW5uZXIAAAAAA+gAAAAT",
        "AAAAAQAAAAAAAAAAAAAAClNjb3JlQm9hcmQAAAAAAAQAAAAAAAAAB2Jlc3Rfb2YAAAAABAAAAAAAAAAFZHJhd3MAAAAAAAAEAAAAAAAAAAZ3aW5zX2EAAAAAAAQAAAAAAAAABndpbnNfYgAAAAAABA==",
        "",
        "AAAAAAAAAAAAAAAGY29tbWl0AAAAAAACAAAAAAAAAAZwbGF5ZXIAAAAAABMAAAAAAAAABGhhc2gAAAPuAAAAIAAAAAA=",
        "AAAAAAAAAAAAAAAGcmV2ZWFsAAAAAAADAAAAAAAAAAZwbGF5ZXIAAAAAABMAAAAAAAAABmNob2ljZQAAAAAABAAAAAAAAAAEc2FsdAAAA+4AAAAgAAAAAA==",
        "AAAAAAAAAAAAAAAJZ2V0X3Njb3JlAAAAAAAAAAAAAAEAAAfQAAAAClNjb3JlQm9hcmQAAA==",
        "AAAAAAAAAAAAAAAJZ2V0X3N0YXRlAAAAAAAAAAAAAAEAAAfQAAAACk1hdGNoU3RhdGUAAA==",
        "AAAAAAAAAAAAAAAJbmV3X21hdGNoAAAAAAAAAwAAAAAAAAAIcGxheWVyX2EAAAATAAAAAAAAAAhwbGF5ZXJfYgAAABMAAAAAAAAAB2Jlc3Rfb2YAAAAABAAAAAA=",
        "AAAAAAAAAAAAAAANY2xhaW1fdGltZW91dAAAAAAAAAEAAAAAAAAABnBsYXllcgAAAAAAEwAAAAA=",
  ...
  public readonly fromJSON = {
    commit: this.txFromJSON<null>,
        ...
        get_score: this.txFromJSON<ScoreBoard>,
        get_state: this.txFromJSON<MatchState>,
        new_match: this.txFromJSON<null>,
