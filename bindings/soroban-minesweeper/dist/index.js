...
export class Client extends ContractClient {
    ...
    constructor(options) {
        super(new ContractSpec(["",
    ...
    fromJSON = {
        ...
        reveal_cell: (this.txFromJSON),
        get_visible_cell: (this.txFromJSON)
    };
}
