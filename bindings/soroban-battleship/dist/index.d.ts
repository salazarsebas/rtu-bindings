...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CCAPWWDWSI2PEHJ6TXXDZ5EOKIPQZAEZQYQ4B6VQ5K74BE3OCPQ7F6VV";
    };
};
export type Phase = {
    tag: "Setup";
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        attack: (json: string) => AssembledTransaction<null>;
        new_game: (json: string) => AssembledTransaction<null>;
        get_state: (json: string) => AssembledTransaction<GameState>;
        reveal_cell: (json: string) => AssembledTransaction<null>;
        commit_board: (json: string) => AssembledTransaction<null>;
    };
}
