...
export const networks = {
  testnet: {
    ...
    contractId: "CAT4KB2Y4LRGXFF2SIW6Z4UAGKNFYVDOJOFTNRWF3AM2ZJUW5YLGSVO2",
  }
} as const
...
export interface Client {
   ...
   */
  init_game: ({player_one, player_two}: {player_one: string, player_two: string}, options?: MethodOptions) => Promise<AssembledTransaction<GameState>>

  /**
   * Construct and simulate a drop_piece transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Drop a piece in a column (0-6)
   * Gravity automatically places piece in lowest available row
   */
  drop_piece: ({player, column}: {player: string, column: u32}, options?: MethodOptions) => Promise<AssembledTransaction<DropResult>>

  /**
   * Construct and simulate a get_winner transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Get the winner's address if game is over
   */
  get_winner: (options?: MethodOptions) => Promise<AssembledTransaction<Option<string>>>
  ...
  /**
   * Construct and simulate a is_valid_column transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Check if a column is valid (within bounds and not full)
   */
  is_valid_column: ({column}: {column: u32}, options?: MethodOptions) => Promise<AssembledTransaction<boolean>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAwAAAClDZWxsIHZhbHVlOiAwPUVtcHR5LCAxPVBsYXllcjEsIDI9UGxheWVyMgAAAAAAAAAAAAAEQ2VsbAAAAAMAAAAAAAAABUVtcHR5AAAAAAAAAAAAAAAAAAAHUGxheWVyMQAAAAABAAAAAAAAAAdQbGF5ZXIyAAAAAAI=",
        "",
        "AAAAAQAAACRNb3ZlIHJlc3VsdCByZXR1cm5lZCBhZnRlciBlYWNoIG1vdmUAAAAAAAAACkRyb3BSZXN1bHQAAAAAAAQAAAAAAAAACmdhbWVfc3RhdGUAAAAAB9AAAAAJR2FtZVN0YXRlAAAAAAAAAAAAAAdtZXNzYWdlAAAAABEAAAAAAAAACnJvd19wbGFjZWQAAAAAA+gAAAAEAAAAAAAAAAdzdWNjZXNzAAAAAAE=",
        "",
        "AAAAAQAAADFCb2FyZCBjb21wb25lbnQgLSBzdG9yZXMgdGhlIDd4NiBnYW1lIGJvYXJkIHN0YXRlAAAAAAAAAAAAAA5Cb2FyZENvbXBvbmVudAAAAAAAAgAAAAAAAAAFY2VsbHMAAAAAAAPqAAAABAAAAAAAAAAJZW50aXR5X2lkAAAAAAAABA==",
        "AAAAAQAAADFQbGF5ZXIgY29tcG9uZW50IC0gc3RvcmVzIGJvdGggcGxheWVycycgYWRkcmVzc2VzAAAAAAAAAAAAAA9QbGF5ZXJDb21wb25lbnQAAAAAAwAAAAAAAAAJZW50aXR5X2lkAAAAAAAABAAAAAAAAAAKcGxheWVyX29uZQAAAAAAEwAAAAAAAAAKcGxheWVyX3R3bwAAAAAAEw==",
        "",
        "AAAAAAAAAClHZXQgdGhlIGJvYXJkIHN0YXRlIGFzIGEgZmxhdHRlbmVkIHZlY3RvcgAAAAAAAAlnZXRfYm9hcmQAAAAAAAAAAAAAAQAAA+oAAAAE",
        "AAAAAAAAABpHZXQgdGhlIGN1cnJlbnQgZ2FtZSBzdGF0ZQAAAAAACWdldF9zdGF0ZQAAAAAAAAAAAAABAAAH0AAAAAlHYW1lU3RhdGUAAAA=",
        "AAAAAAAAACZJbml0aWFsaXplIGEgbmV3IGdhbWUgd2l0aCB0d28gcGxheWVycwAAAAAACWluaXRfZ2FtZQAAAAAAAAIAAAAAAAAACnBsYXllcl9vbmUAAAAAABMAAAAAAAAACnBsYXllcl90d28AAAAAABMAAAABAAAH0AAAAAlHYW1lU3RhdGUAAAA=",
        "AAAAAAAAAFlEcm9wIGEgcGllY2UgaW4gYSBjb2x1bW4gKDAtNikKR3Jhdml0eSBhdXRvbWF0aWNhbGx5IHBsYWNlcyBwaWVjZSBpbiBsb3dlc3QgYXZhaWxhYmxlIHJvdwAAAAAAAApkcm9wX3BpZWNlAAAAAAACAAAAAAAAAAZwbGF5ZXIAAAAAABMAAAAAAAAABmNvbHVtbgAAAAAABAAAAAEAAAfQAAAACkRyb3BSZXN1bHQAAA==",
        "AAAAAAAAAChHZXQgdGhlIHdpbm5lcidzIGFkZHJlc3MgaWYgZ2FtZSBpcyBvdmVyAAAACmdldF93aW5uZXIAAAAAAAAAAAABAAAD6AAAABM=",
        "AAAAAAAAACRSZXNldCB0aGUgZ2FtZSB3aXRoIHRoZSBzYW1lIHBsYXllcnMAAAAKcmVzZXRfZ2FtZQAAAAAAAAAAAAEAAAfQAAAACUdhbWVTdGF0ZQAAAA==",
        "AAAAAAAAAB1DaGVjayBpZiB0aGUgZ2FtZSBpcyBmaW5pc2hlZAAAAAAAAAtpc19maW5pc2hlZAAAAAAAAAAAAQAAAAE=",
        "AAAAAAAAADdDaGVjayBpZiBhIGNvbHVtbiBpcyB2YWxpZCAod2l0aGluIGJvdW5kcyBhbmQgbm90IGZ1bGwpAAAAAA9pc192YWxpZF9jb2x1bW4AAAAAAQAAAAAAAAAGY29sdW1uAAAAAAAEAAAAAQAAAAE=",
  ...
  public readonly fromJSON = {
    get_board: this.txFromJSON<Array<u32>>,
        get_state: this.txFromJSON<GameState>,
        init_game: this.txFromJSON<GameState>,
        drop_piece: this.txFromJSON<DropResult>,
        get_winner: this.txFromJSON<Option<string>>,
        reset_game: this.txFromJSON<GameState>,
        is_finished: this.txFromJSON<boolean>,
        is_valid_column: this.txFromJSON<boolean>
  }
}