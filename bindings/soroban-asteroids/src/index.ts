...
export const networks = {
  testnet: {
    ...
    contractId: "CBXOSKHYMU3OSANHIORRZIHQ5DC4OZDZAZ65CEKGQPOMQE4HKP7FOYBS",
  }
} as const
...
export interface ECSWorldState {
  asteroids: Array<AsteroidComponent>;
  bullets: Array<BulletComponent>;
  game_over: boolean;
...
export interface Client {
  /**
   * Construct and simulate a shoot transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  shoot: (options?: MethodOptions) => Promise<AssembledTransaction<null>>
  ...
  /**
   * Construct and simulate a rotate_ship transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  rotate_ship: ({delta_steps}: {delta_steps: i32}, options?: MethodOptions) => Promise<AssembledTransaction<null>>

  /**
   * Construct and simulate a thrust_ship transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  thrust_ship: (options?: MethodOptions) => Promise<AssembledTransaction<null>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAABAAAAAAAAAAAAAAACUdhbWVFcnJvcgAAAAAAAAQAAAAAAAAADk5vdEluaXRpYWxpemVkAAAAAAABAAAAAAAAABJBbHJlYWR5SW5pdGlhbGl6ZWQAAAAAAAIAAAAAAAAACEdhbWVPdmVyAAAAAwAAAAAAAAANSW52YWxpZEFjdGlvbgAAAAAAAAQ=",
        "",
        "",
        "AAAAAQAAAAAAAAAAAAAADVNoaXBDb21wb25lbnQAAAAAAAAFAAAAAAAAAAVhbmdsZQAAAAAAAAQAAAAAAAAAAnZ4AAAAAAALAAAAAAAAAAJ2eQAAAAAACwAAAAAAAAABeAAAAAAAAAsAAAAAAAAAAXkAAAAAAAAL",
        "AAAAAQAAAAAAAAAAAAAADlNjb3JlQ29tcG9uZW50AAAAAAACAAAAAAAAAAVsaXZlcwAAAAAAAAQAAAAAAAAABnBvaW50cwAAAAAABA==",
        "AAAAAQAAAAAAAAAAAAAAD0J1bGxldENvbXBvbmVudAAAAAAFAAAAAAAAAAhsaWZldGltZQAAAAQAAAAAAAAAAnZ4AAAAAAALAAAAAAAAAAJ2eQAAAAAACwAAAAAAAAABeAAAAAAAAAsAAAAAAAAAAXkAAAAAAAAL",
        "AAAAAQAAAAAAAAAAAAAAEUFzdGVyb2lkQ29tcG9uZW50AAAAAAAABQAAAAAAAAAEc2l6ZQAAAAQAAAAAAAAAAnZ4AAAAAAALAAAAAAAAAAJ2eQAAAAAACwAAAAAAAAABeAAAAAAAAAsAAAAAAAAAAXkAAAAAAAAL",
        "AAAAAAAAAAAAAAAFc2hvb3QAAAAAAAAAAAAAAA==",
        "AAAAAAAAAAAAAAAJZ2V0X3Njb3JlAAAAAAAAAAAAAAEAAAAE",
        "AAAAAAAAAAAAAAAJaW5pdF9nYW1lAAAAAAAAAAAAAAA=",
        "AAAAAAAAAAAAAAALcm90YXRlX3NoaXAAAAAAAQAAAAAAAAALZGVsdGFfc3RlcHMAAAAABQAAAAA=",
        "AAAAAAAAAAAAAAALdGhydXN0X3NoaXAAAAAAAAAAAAA=",
        "AAAAAAAAAAAAAAALdXBkYXRlX3RpY2sAAAAAAAAAAAA=",
        "AAAAAAAAAAAAAAAOZ2V0X2dhbWVfc3RhdGUAAAAAAAAAAAABAAAH0AAAAAlHYW1lU3RhdGUAAAA=",
        "AAAAAAAAAAAAAAAPY2hlY2tfZ2FtZV9vdmVyAAAAAAAAAAABAAAAAQ==",
  ...
  public readonly fromJSON = {
    shoot: this.txFromJSON<null>,
        get_score: this.txFromJSON<u32>,
        init_game: this.txFromJSON<null>,
        rotate_ship: this.txFromJSON<null>,
        thrust_ship: this.txFromJSON<null>,
