...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CDMIVUM7KWKDWQ5UVCIOLSKPY3KK3YUFICAYSQT3V2VBJTGKGIIMCH3T";
    };
};
/**
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        init_game: (json: string) => AssembledTransaction<null>;
        update_tick: (json: string) => AssembledTransaction<null>;
        get_food_pos: (json: string) => AssembledTransaction<readonly [number, number]>;
        get_head_pos: (json: string) => AssembledTransaction<readonly [number, number]>;
        get_grid_size: (json: string) => AssembledTransaction<number>;
        check_game_over: (json: string) => AssembledTransaction<boolean>;
        change_direction: (json: string) => AssembledTransaction<boolean>;
        get_snake_length: (json: string) => AssembledTransaction<number>;
        get_snake_positions: (json: string) => AssembledTransaction<(readonly [number, number])[]>;
        init_game_with_size: (json: string) => AssembledTransaction<null>;
    };
}
