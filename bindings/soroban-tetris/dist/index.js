...
(function (TetrominoShape) {
    ...
    TetrominoShape[TetrominoShape["J"] = 1] = "J";
    TetrominoShape[TetrominoShape["L"] = 2] = "L";
    TetrominoShape[TetrominoShape["O"] = 3] = "O";
    TetrominoShape[TetrominoShape["S"] = 4] = "S";
    TetrominoShape[TetrominoShape["T"] = 5] = "T";
...
export class Client extends ContractClient {
    ...
    constructor(options) {
        super(new ContractSpec(["AAAAAQAAAAAAAAAAAAAABVBpZWNlAAAAAAAABAAAAAAAAAAIcm90YXRpb24AAAAEAAAAAAAAAAVzaGFwZQAAAAAAB9AAAAAOVGV0cm9taW5vU2hhcGUAAAAAAAAAAAABeAAAAAAAAAUAAAAAAAAAAXkAAAAAAAAF",
    ...
    fromJSON = {
        drop: (this.txFromJSON),
        rotate: (this.txFromJSON),
        get_state: (this.txFromJSON),
        init_game: (this.txFromJSON),
        move_down: (this.txFromJSON),
        move_left: (this.txFromJSON),
        move_right: (this.txFromJSON),
